...
import sysco.com.cart.dto.error.ErrorDto;
import sysco.com.cart.dto.response.ResponseObject;
import sysco.com.cart.exception.DatabaseException;
...
public class AbstractController {
    ...
    @ResponseBody
    public ResponseEntity<ResponseObject> handleCartCreationException(CartCreationException ex) {
        log.error("USER_CREATION_ERROR", ex);
        return sendBadRequestResponse(new ErrorDto("USER_CREATION_ERROR", ex.getMessage()));
    }
    ...
    @ResponseBody
    public ResponseEntity<ResponseObject> handleCartNotFoundException(CartNotFoundException ex) {
