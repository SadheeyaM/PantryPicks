...
import com.sysco.product.dto.error.ErrorDto;
import com.sysco.product.dto.response.ResponseObject;
import com.sysco.product.exception.DatabaseException;
import com.sysco.product.exception.ProductCreationException;
import com.sysco.product.exception.ProductException;
import com.sysco.product.exception.ProductNotFoundException;
...
public class AbstractController {
    ...
    @ResponseBody
    public ResponseEntity<ResponseObject> handleProductException(ProductException ex) {
...
//    @ResponseBody
//    public ResponseEntity<ResponseObject> handleProductCreationException(ProductCreationException ex) {
...
//    @ResponseBody
//    public ResponseEntity<ResponseObject> handleProductNotFoundException(ProductNotFoundException ex) {
